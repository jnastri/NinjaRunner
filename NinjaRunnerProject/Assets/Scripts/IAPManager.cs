...
public class IAPManager : MonoBehaviour, IStoreListener
{
    ...
    public static string productScrolls25 = "scroll25";
    public static string productScrolls50 = "scroll50";
    ...
    public void InitializePurchasing()
    {
        ...
        builder.AddProduct(productScrolls25, ProductType.Consumable);
        builder.AddProduct(productScrolls50, ProductType.Consumable);
    ...
    public void Buy_25_Scrolls()
    {
        // Buy the consumable product using its general identifier. Expect a response either 
        // through ProcessPurchase or OnPurchaseFailed asynchronously.
        BuyProductID(productScrolls25);
    }
    public void Buy_50_Scrolls()
    {
        // Buy the non-consumable product using its general identifier. Expect a response either 
        // through ProcessPurchase or OnPurchaseFailed asynchronously.
        BuyProductID(productScrolls50);
    }
